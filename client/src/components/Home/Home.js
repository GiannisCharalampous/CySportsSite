  ...
  return (
    <Grow in>
      <Container maxWidth="xl">
        <h1 style={{textAlign: 'center'}}>WELCOME TO OUR SPORTS SITE</h1>
        <h4 style={{textAlign: 'center', color: 'grey'}}>In our site you can read sports news and search for
          players to play basketball or football with them in Cyprus!</h4>
        {<br/>}{<br/>}
        <div style={{ marginRight: '-10%', marginLeft: '10%'}}>
        <Slideshow />
        </div>
        {<br/>}{<br/>}{<br/>}{<br/>}
        <h3>Posts from our registered Users:</h3>
